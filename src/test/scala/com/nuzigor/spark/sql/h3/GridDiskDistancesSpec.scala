...
class GridDiskDistancesSpec extends H3Spec {
  ...
  it should "support compiled function" in {
    ...
    val result = df.select(h3_grid_disk_distances(col("h3"), 1))
  ...
  protected override def functionName: String = "h3_grid_disk_distances"
}
